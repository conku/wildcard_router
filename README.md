...
[![GoDoc](https://godoc.org/github.com/conku/wildcard_router?status.svg)](https://godoc.org/github.com/conku/wildcard_router)
...
Those URLs could be anything, with no rule... Let's initialize [WildcardRouter](https://github.com/conku/wildcard_router) and mount it.
...
`AddHandler` to [WildcardRouter](https://github.com/conku/wildcard_router) and any model that implements method `ServeHTTP` can be routed to as a handler.
